              ...
              TextFormField(
                ...
                validator: (value) {
                  if (value == null || value.replaceAll(' ', '').length != 16) {
                    return "Lütfen 16 haneli bir kart numarası giriniz";
                  }
                  return null;
                },
              ),
  ...
  void _processPayment() {
    showDialog(
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          title: Text("ÖDEME BAŞARILI"),
          content: Column(
            mainAxisSize: MainAxisSize.min,
            children: <Widget>[
              Lottie.asset('assets/confirmed3.json',
                  width: 100), 
              Text("Ödemeniz için teşekkür ederiz!"),
            ],
          ),
          actions: <Widget>[
            TextButton(
